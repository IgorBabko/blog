<section id="uploads-section" class="container-fluid section-content">
	{{-- Top Bar --}}
	<div class="row page-title-row">
		<div class="col-md-6">
			...
			<div class="pull-left">
				<ul class="breadcrumb">
					@foreach ($uploads['breadcrumbs'] as $path => $disp)
					<li>
						<a href="/admin/upload?folder={{ $path }}"> {{ $disp }} </a>
					</li>
					@endforeach
					<li class="active"> {{ $uploads['folderName'] }} </li>
				</ul>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<table id="uploads-table" class="table table-striped table-bordered">
				...
				<tbody>
					{{-- The Subfolders --}}
					@foreach ($uploads['subfolders'] as $path => $name)
					<tr>
						<td>
