<section id="about-section">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="/assets/img/1.jpeg" alt="Chania">
    </div>

    <div class="item">
      <img src="/assets/img/2.jpg" alt="Chania">
    </div>

    <div class="item">
      <img src="/assets/img/3.jpg" alt="Flower">
    </div>

    <div class="item">
      <img src="/assets/img/2.jpg" alt="Flower">
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <img id="me-img" src="/assets/img/me-portrait.jpg">
        <ul class="nav nav-tabs nav-justified">
            <li><a href="#about-me" data-toggle="tab">About me</a></li>
            <li><a href="#auto-biography" data-toggle="tab">Auto-biography</a></li>
            <li><a href="#cv" data-toggle="tab">CV</a></li>
        </ul>
        <div class="tab-content" id="tabs">
            ...
            <div class="tab-pane" id="auto-biography">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum repellendus quam nisi sed expedita incidunt ullam minus nihil dolorem amet.</p>
                <p>Eaque veritatis error magnam, temporibus odio aspernatur blanditiis nesciunt nulla non et, vitae cum? Iure, expedita, aut. Eos, consectetur, voluptatem.</p>
                <p>ситуации, как часть более широкого явления. <span class="highlighter">Автор аргументирует</span> и выстраивает свою позицию через систему фактов.
                В статье в
