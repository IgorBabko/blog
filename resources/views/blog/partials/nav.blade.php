  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav menu-links">
  		...
  		<li>
  			<a href="#" data-section-id="posts-section">Posts</a>
  		</li>
  		<li>
  			<a href="#" data-section-id="questions-section">Questions</a>
  		</li>
      </ul>
      <ul class="nav navbar-nav navbar-right list-inline text-center social-links">
		  <li>
  			<a href="{{ url('rss') }}" data-toggle="tooltip"
  				title="RSS feed">
  				<span class="fa-stack fa-lg rss">
